			...
			<div class="new-product">
				<div class="col-md-5 zoom-grid">
					<div class="flexslider">
						<ul class="slides">
							...
							<li data-thumb="/{{ $val->name_file }}">
								<div class="thumb-image"> <img src="/{{ $val->name_file }}" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							@endforeach
							<li data-thumb="/images/p6.jpg">
								<div class="thumb-image"> <img src="/images/p6.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="/images/p1.jpg">
								<div class="thumb-image"> <img src="/images/p1.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="/images/p5.jpg">
							<div class="thumb-image"> <img src="/images/p5.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li> 
						</ul>
					</div>
				</div>
				<div class="col-md-7 dress-info">
					...
					<div class="dress-name">
						<h3><strong>{{ $val->name_product }}</strong></h3>
						<span>Rp {{ number_format($val->price_product) }}</span>
						<div class="clearfix"></div>
						<p>{{ $val->description_product }}</p>
