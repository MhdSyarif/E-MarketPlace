...
<div class="banner-bottom">
	...
	<div class="shop">
		<a href="{{ url('/product') }}">SHOP COLLECTION NOW</a>
	</div>
	</div>
		</div>
			...
			<div class="main-content">
				...
				<header>
					...
					<div class="col-md-4 product simpleCart_shelfItem text-center">
						@if ($val->name_file != '')
							<a href="{{ url('/product',$val->id_product) }}"><img src="{{$val->name_file}}" alt="" /></a>
						@else
							<a href="{{ url('/product',$val->id_product) }}"><img src="images/p1.jpg" alt="" /></a>
						@endif
						<div class="mask">
							<a href="{{ url('/product',$val->id_product) }}">Quick View</a>
						</div>
						<a class="product_name" href="{{ url('/product') }}">{{ $val->name_product }}</a>
						<p><a class="item_add" href="#"><i></i> <span class="item_price">Rp. {{ number_format($val->price_product) }}</span></a></p>
					</div>
					@endforeach
					<!-- <div class="col-md-4 product simpleCart_shelfItem text-center">
						<a href="{{ url('/product') }}"><img src="images/p2.jpg" alt="" /></a>
						<div class="mask">
			...
			<h3 class="like text-center">Featured Collection</h3>        			
				     <ul id="flexiselDemo3">
						<li><a href="single.html"><img src="images/l1.jpg" class="img-responsive" alt="" /></a>
							...
							<a class="like_name" href="{{ url('/product') }}">perfectly simple</a>
							<p><a class="item_add" href="#"><i></i> <span class=" item_price">$759</span></a></p>
							</div>
						</li>
						<li><a href="{{ url('/product') }}"><img src="images/l4.jpg" class="img-responsive" alt="" /></a>						
							<div class="product liked-product simpleCart_shelfItem">
							<a class="like_name" href="{{ url('/product') }}">praising pain</a>
							<p><a class="item_add" href="#"><i></i> <span class=" item_price">$699</span></a></p>
							</div>
						</li>
						<li><a href="{{ url('/product') }}"><img src="images/l5	.jpg" class="img-responsive" alt="" /></a>
							<div class="product liked-product simpleCart_shelfItem">
							<a class="like_name" href="{{ url('/product') }}">Neque porro</a>
							<p><a class="item_add" href="#"><i></i> <span class=" item_price">$329</span></a></p>
							</div>
						</li>
						<li><a href="{{ url('/product') }}"><img src="images/l4.jpg" class="img-responsive" alt="" /></a>
							<div class="product liked-product simpleCart_shelfItem">
							<a class="like_name" href="{{ url('/product') }}">equal blame</a>
