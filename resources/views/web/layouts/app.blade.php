			...
			<div class="container">
				<div class="header-top-left">
					<ul>
						...
						<li><a href="{{ url('/register') }}"><span class="glyphicon glyphicon-lock"> </span>Create an Account</a></li>			
					</ul>
				</div>
		...
		<div class="container">
		 <div class="footer_top">
		  ...
		  <div class="copyright text-center">
				<p>© 2016 Eshop. All Rights Reserved | Design by   <a href="http://w3layouts.com">  W3layouts</a></p>
		  </div>
		</div>
		</div>
</body>
